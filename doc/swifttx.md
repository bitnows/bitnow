...
* WebSocket: [https://github.com/Bitnow-Core/insight-api-bitnow#web-socket-api](https://github.com/Bitnow-Core/insight-api-bitnow#web-socket-api)
* API: [https://github.com/Bitnow-Core/insight-api-bitnow#swifttx-transactions](https://github.com/Bitnow-Core/insight-api-bitnow#swifttx-transactions)
...
By default, the Bitnow Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitnow Core daemon:
