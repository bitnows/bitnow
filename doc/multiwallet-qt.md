...
In order to support loading of multiple wallets in bitnow-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitnow.cpp.
...
Changes to bitnow.cpp
----------------------
bitnow.cpp is the entry point into bitnow-qt, and as such, will require some minor modifications to provide hooks for
