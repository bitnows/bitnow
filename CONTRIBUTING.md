Contributing to Bitnow Core
============================

The Bitnow Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitnow Core project, and is not to be
confused with overall Bitnow Network Protocol consensus changes.

Whether a pull request is merged into Bitnow Core rests with the project merge
...
Patches that change Bitnow consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitnow consensus, it must have been
...
The project leader is the release manager for each Bitnow Core release.
