...
#   c) node1 mines 32 blocks, so now node 0 has 60001bitnow, node 1 has 4250bitnow, node2 has none.
#   d) node0 sends 601 bitnow to node2, in two transactions (301 bitnow, then 300 bitnow).
