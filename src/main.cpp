...
#if defined(NDEBUG)
#error "Bitnow cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubitnow) are considered zero fee (for relaying and mining)
