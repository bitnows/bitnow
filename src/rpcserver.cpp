...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitnow features */
        {"bitnow", "masternode", &masternode, true, true, false},
        {"bitnow", "listmasternodes", &listmasternodes, true, true, false},
        {"bitnow", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitnow", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitnow", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitnow", "masternodedebug", &masternodedebug, true, true, false},
        {"bitnow", "startmasternode", &startmasternode, true, true, false},
        {"bitnow", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitnow", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitnow", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitnow", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitnow", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitnow", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitnow", "mnsync", &mnsync, true, true, false},
        {"bitnow", "spork", &spork, true, true, false},
        {"bitnow", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitnow", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitnowd, or the -server option to bitnow-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitnow-cli " + methodname + " " + args + "\n";
}
