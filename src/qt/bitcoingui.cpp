...
QFontDatabase::addApplicationFont(":/fonts/bitnow_font");

QString windowTitle = tr("Bitnow Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitnow address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Bitnow: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitnow Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitnow Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitnow"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitnow addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitnow addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bitnow: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bitnow Core help message to get a list with possible Bitnow command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitnow Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitnow network", "", count));
}
...
{
    QString strTitle = tr("Bitnow Core"); // default title
