...
/** Utility functions used by the Bitnow Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitnow addresses in monospace font
...
// Parse "bitnow:" URI into recipient object, return true on successful parsing
