/* src/config/bitnow-config.h.  Generated from bitnow-config.h.in by configure.  */
/* src/config/bitnow-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Bitnow_CONFIG_H

#define Bitnow_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bitnow.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitnow Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitnow Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitnow"
