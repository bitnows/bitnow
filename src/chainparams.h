 ...
 * Bitnow system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& BitnowDevKey() const { return vBitnowDevKey; }
    // const std::vector<unsigned char>& BitnowFundKey() const { return vBitnowFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vBitnowDevKey;
    // std::vector<unsigned char> vBitnowFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
