...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitnow Core bitnow-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitnow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Bitnow transaction") + "\n" +
                               "  bitnow-tx [options] -create [commands]   " + _("Create hex-encoded Bitnow transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Bitnow transaction
