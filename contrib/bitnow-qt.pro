...
RESOURCES += src/qt/bitnow.qrc src/qt/bitnow_locale.qrc

TRANSLATIONS += src/qt/locale/bitnow_bg.ts \
                src/qt/locale/bitnow_de.ts \
                src/qt/locale/bitnow_en.ts \
                src/qt/locale/bitnow_es.ts \
                src/qt/locale/bitnow_fi.ts \
                src/qt/locale/bitnow_fr.ts \
                src/qt/locale/bitnow_it.ts \
                src/qt/locale/bitnow_ja.ts \
                src/qt/locale/bitnow_pl.ts \
                src/qt/locale/bitnow_pt.ts \
                src/qt/locale/bitnow_ru.ts \
                src/qt/locale/bitnow_sk.ts \
                src/qt/locale/bitnow_sv.ts \
                src/qt/locale/bitnow_vi.ts \
                src/qt/locale/bitnow_zh_CN.ts \
                src/qt/locale/bitnow_zh_TW.ts
